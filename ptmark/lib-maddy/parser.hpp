 ...
 */
#pragma once
#ifndef MADDY_PARSER_HPP
#define MADDY_PARSER_HPP
...
// BlockParser
#include "checklistparser.hpp"
#include "codeblockparser.hpp"
#include "headlineparser.hpp"
#include "horizontallineparser.hpp"
#include "htmlparser.hpp"
#include "latexblockparser.hpp"
#include "orderedlistparser.hpp"
#include "paragraphparser.hpp"
#include "quoteparser.hpp"
#include "tableparser.hpp"
#include "unorderedlistparser.hpp"

// LineParser
#include "breaklineparser.hpp"
#include "emphasizedparser.hpp"
#include "imageparser.hpp"
#include "inlinecodeparser.hpp"
#include "italicparser.hpp"
#include "linkparser.hpp"
#include "strikethroughparser.hpp"
#include "strongparser.hpp"

using maddy::ParserConfig;
...
public:
   ...
   * Version info
   *
   * Check https://github.com/progsource/blob/master/CHANGELOG.md
   * for the changelog.
   */
  ...
  {
    if (!this->config ||
        (this->config.get()->enabledParsers & maddy::types::BREAKLINE_PARSER) != 0)
    {
  ...
  ) const
  {
    ...
    else if (maddy::ParagraphParser::IsStartingLine(line))
    {
      parser = std::make_shared<maddy::ParagraphParser>(
        ...
        !this->config || (this->config->enabledParsers & maddy::types::CONFIG_PARSER) != 0
      );
    }
